...
tallNacer <- summary(lm(Talla_hoy ~ Talla_nacer))
tallNacer_c <- cbind(tallNacer$r.squared, tallNacer$adj.r.squared)
...
tallToraxNacer <- summary(lm(Talla_hoy ~ Talla_nacer + Torax_nacer))
tallToraxNacer_c <- cbind(tallToraxNacer$r.squared, tallToraxNacer$adj.r.squared)
...
tablaR2 <- rbind(pesoNacer_c, tallNacer_c ,toraxNacer_c, pesoTallaNacer_c, pesoToraxNacer_c, tallToraxNacer_c, pesoTallaToraxNacer_c )
